  ...
  return (
    <div className='flex w-11/12 justify-between max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0'>
        <div className='w-11/12 max-w-[450px]'>
            ...
            <p className='text-[1.125rem] leading-[1.625ren] mt-4'>
            ...
            <button className='w-full flex justify-center items-center first-letter rounded-[8px] font-medium text-richblack-100
